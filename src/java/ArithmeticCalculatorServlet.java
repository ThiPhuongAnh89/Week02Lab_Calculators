...
public class ArithmeticCalculatorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String firstNum = request.getParameter("first");
         ...
         {
             request.setAttribute("result", "null value");
         }
         else if(firstNum =="" || secondNum == "")
         {
             ...
             try{
                numfirst = Float.parseFloat(firstNum);
                 numsecond = Float.parseFloat(secondNum);
             ...
             if(request.getParameter("add")!=null){
                 request.setAttribute("result", (numfirst + numsecond));
             }
...
//            out.println("</html>");
//        }
getServletContext().getRequestDispatcher("/arithmeticcaculator.jsp").forward(request, response);
    }
