...
//        }
        ...
        if(age == null)
        {
           ...
           if(age=="")   
        {  
                request.setAttribute("notice", "You must give your current age");
        ...
        else 
         {
            ...
            request.setAttribute("notice","your next birthday will be: " +number );
             
        }
    catch(NumberFormatException e){
           request.setAttribute("notice", "You must enter number");
